...
/// Pequeño helper compartido por DPadCameraController (pellizco para zoom) y
/// DPadCameraTranslator (arrastre de dos dedos para desplazar), para que ambos
/// lean los toques de la misma forma y con la misma regla de exclusión sobre
/// UI que ya usa el arrastre con mouse (!EventSystem.current.IsPointerOverGameObject()).
///
